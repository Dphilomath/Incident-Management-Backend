...
function Navbar() {
  ...
  return (
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="container">
        {/* <!-- Navbar brand --> */}
        <a class="navbar-brand" href="#"><img id="lowes-logo"
            src={Loweslogo2} alt="Lowes Logo"
            draggable="false" height="45" /></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav ms-3">
            <li class="nav-item me-3">
                <NavLink to="/addIncident" className='nav-link d-flex align-items-center'>
